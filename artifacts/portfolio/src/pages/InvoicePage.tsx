...
export default function InvoicePage() {
  ...
  const [items, setItems] = useState<LineItem[]>([
    { id: "1", description: "AI Development Services", quantity: 1, rate: 50000 },
  ]);
    ...
    <div className="min-h-screen py-12">
      ...
      <div className="no-print container mx-auto px-4 mb-8">
        ...
        <p className="text-sm text-muted-foreground">
          Fill in the details — the preview on the right updates live. Click Download to save as PDF.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="no-print space-y-6">
          ...
          <div className="bg-card border border-border/50 rounded-2xl p-6">
            ...
            <div>
              <Label htmlFor="tax-rate">Tax Rate (%) — set 0 if not applicable</Label>
              <Input
                id="tax-rate"
                type="number"
                min="0"
        ...
        <div className="lg:sticky lg:top-24 lg:self-start">
          <div className="print-area bg-white text-black border border-border/50 rounded-2xl p-8 md:p-10 shadow-lg lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto">
            ...
            <div className="flex items-start justify-between mb-8 pb-6 border-b border-gray-300">
              ...
              <div className="text-right">
                ...
                <div className="text-xl font-bold mb-3">#{invoiceNumber || "—"}</div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded p-3 mb-6 text-xs">
              ...
              <span className="font-semibold">{numberToWordsINR(totals.total)}</span>
            </div>

            {/* Bank Details */}
            <div className="mb-6 text-xs">
              <div className="uppercase tracking-widest text-gray-500 text-[10px] mb-2">
                Bank Details
              </div>
          ...
          <div className="no-print mt-4 text-xs text-muted-foreground flex items-start gap-2">
            ...
            <span>
              Edit your address and bank details in{" "}
              <code className="font-mono text-primary">src/lib/companyInfo.ts</code>.
            </span>
          </div>
        </div>
      </div>
